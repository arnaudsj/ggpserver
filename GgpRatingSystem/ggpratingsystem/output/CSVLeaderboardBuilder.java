...
public class CSVLeaderboardBuilder implements LeaderboardBuilder {
	private final CSVRatingsWriter writer;
	private final List<Player> players;

	private double[] nextLine;

	public CSVLeaderboardBuilder(Writer writer, List<Player> players, RatingSystemType type) throws IOException {
		this(writer, players);
	...
	public CSVLeaderboardBuilder(Writer writer, List<Player> players, double[] initialRatings) throws IOException {
		this(writer, players);
	...
	private CSVLeaderboardBuilder(Writer writer, List<Player> players) throws IOException {
