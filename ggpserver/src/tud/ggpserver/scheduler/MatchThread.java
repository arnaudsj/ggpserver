...
public abstract class MatchThread<TermType extends TermInterface, ReasonerStateInfoType> extends Thread {
	
	private RunningMatch<TermType,ReasonerStateInfoType> match;
	
	public MatchThread(RunningMatch<TermType,ReasonerStateInfoType> match) {
		super("MatchThread("+match.getMatchID()+")");
		this.match = match;
	}
