...
public class StartClockFilterRule extends LongMatchFilterRule{
	...
	public StartClockFilterRule(Filter filter) {
		super(FilterType.StartClock, filter);
	}
	public StartClockFilterRule(Filter filter, Comparison comparison, Long pattern) {
