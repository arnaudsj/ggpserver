...
<jsp:useBean id="createTournament" class="tud.ggpserver.formhandlers.CreateGermanComp10Tournament" scope="request">
	<c:catch>
...
<c:set var="title">Create German GGP Competition '10 Tournament</c:set>
<jsp:directive.include file="/inc/header.jsp" />

<!-- Content -->

	<form action="<%= response.encodeURL("process_create_german_comp10_tournament.jsp") %>" method="post">
	<table cellpadding="4" cellspacing="2" border="0">
		...
		<tr>
			...
			<td>
				<c:forTokens items="1,2,3,4,5" delims="," var="i">
