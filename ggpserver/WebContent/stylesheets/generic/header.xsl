...
-->
			...
			<xsl:variable name="matchID" select="/match/match-id"/>
					...
					<xsl:otherwise>
						<div class="bartab">
							...
							<xsl:attribute name="href">
								view_state.jsp?matchID=<xsl:value-of select="$matchID"/>&amp;stepNumber=1
							</xsl:attribute>
								<img src="../stylesheets/generic/images/leftarrow.png" width="20" height="20"/> Initial State
							</a>
						</div>
						<div class="bartab">
							<a>
							<xsl:attribute name="href">
								view_state.jsp?matchID=<xsl:value-of select="$matchID"/>&amp;stepNumber=<xsl:value-of select="$currentStep - 1"/>
							</xsl:attribute>
								<img src="../stylesheets/generic/images/leftarrow.png" width="20" height="20"/> Previous State
							</a>
						</div>
				...
				<xsl:choose>
					...
					<xsl:otherwise>
						...
						<div class="bartab">
							<a>
							<xsl:attribute name="href">
								view_state.jsp?matchID=<xsl:value-of select="$matchID"/>&amp;stepNumber=final
							</xsl:attribute>
								<img src="../stylesheets/generic/images/rightarrow.png" width="20" height="20"/> Final State
							</a>
						</div>
