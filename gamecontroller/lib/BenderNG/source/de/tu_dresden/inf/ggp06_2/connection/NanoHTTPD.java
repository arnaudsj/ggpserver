                ...
                if ( line != null ) {
                    ...
                    if ( st.hasMoreTokens() ) {
                        ...
                        while ( line != null && line.trim().length() > 0 ) {
                            int p = line.indexOf( ':' );
                            header.put( line.substring( 0, p ).trim(), line
                                    .substring( p + 1 ).trim() );
                            line = in.readLine();
                        }
                    }
                    ...
                    if ( method.equalsIgnoreCase( "POST" ) ) {
                        try {
                            // BUG: Some headers contain Content-length
                            //                      some Content-Length
...
//                    System.out.println( "data length " + length_so_far + " of "
//                            + length );
    ...
    public Response serveFile(String uri, Properties header, File homeDir,
        ...
        if ( !homeDir.isDirectory() )
            return new Response( Response.HTTP_INTERNALERROR, MIME_PLAINTEXT,
        ...
        if ( uri.startsWith( ".." ) || uri.endsWith( ".." )
                || uri.indexOf( "../" ) >= 0 )
            return new Response( Response.HTTP_FORBIDDEN, MIME_PLAINTEXT,
                    "FORBIDDEN: Won't serve ../ for security reasons." );
        File f = new File( homeDir, uri );
        if ( !f.exists() )
            return new Response( Response.HTTP_NOTFOUND, MIME_PLAINTEXT,
        ...
        if ( f.isDirectory() ) {
            ...
            if ( !uri.endsWith( "/" ) ) {
                uri += "/";
                Response r = new Response( Response.HTTP_REDIRECT, MIME_HTML,
            ...
            // No index file, list the directory
                ...
                return new Response( Response.HTTP_OK, MIME_HTML, msg );
            } else {
                return new Response( Response.HTTP_FORBIDDEN, MIME_PLAINTEXT,
        ...
        try {
            ...
            fis.skip( startFrom );
            Response r = new Response( Response.HTTP_OK, mime, fis );
     ...
     */
    private static final String               LICENCE      = "Copyright (c) 2001 Jarno Elonen <elonen@iki.fi>\n"
                                                                   + "\n"
